...
def render_viewer(selected_patient: str, selected_file: str):
    ...
    print(f"DEBUG: render_viewer called with patient={selected_patient}, file={selected_file}")
    ...
    overlays = []
    if selected_patient and viewer_config.settings.get('show_overlay', False):
