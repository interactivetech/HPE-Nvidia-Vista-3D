...
Sets up the Vista3D AI server and GPU-enabled backend services
"""
...
class Vista3DBackendSetup:
    """Backend setup for Vista3D AI server and GPU services"""
    ...
    def print_banner(self):
        ...
        print("="*80)
        print("This script will set up the Vista3D AI server and GPU-enabled backend services.")
        print("It will configure the AI server for medical image segmentation.")
        print("="*80)
        ...
        print("✅ Configures NVIDIA NGC integration")
        print("✅ Creates all necessary directories and files")
        print("✅ Sets up GPU-accelerated AI inference")
    ...
    def check_system_requirements(self) -> bool:
        """Check system requirements for backend services"""
        print("\n" + "="*60)
        ...
        if issues:
            ...
            print("   Your system is ready for Vista3D backend setup.")
    ...
    def gather_configuration(self) -> Dict:
        """Gather configuration for backend services"""
        print("\n" + "="*60)
        print("📝 CONFIGURATION")
        print("="*60)
        ...
        config['NVIDIA_VISIBLE_DEVICES'] = "0"
        print("✅ GPU configuration: Using GPU 0")
    ...
    def print_next_steps(self, config: Dict):
        ...
        print("\n📋 NEXT STEPS:")
        print("\n1. 🚀 Start Vista3D AI server:")
        print("   python start.py --vista3d-only")
        print("   • This starts the Vista3D AI server with GPU acceleration")
        print("   • Server will run in Docker container with GPU access")
        
        print("\n2. 🌐 Start frontend services (on same or different machine):")
        print("   python start.py --frontend-only")
        print("   • This starts the web interface and image server")
        print("   • Configure to connect to this Vista3D server")
        
        print("\n3. 🔗 Or start all services together:")
        print("   python start.py")
        print("   • This starts both frontend and backend services")
        
        print(f"\n📄 Configuration saved to: {self.env_file}")
        print("🔐 Keep your .env file secure - it contains your API key")
        
        print("\n🧠 Vista3D AI Server Details:")
        print(f"   • Server URL: {config['VISTA3D_SERVER']}")
        print("   • GPU acceleration enabled")
        print("   • Medical image segmentation ready")
        print("   • Supports DICOM and NIFTI formats")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
This script sets up the Vista3D AI server and GPU-enabled backend services.
